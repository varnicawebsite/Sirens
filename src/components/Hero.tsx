...
const Hero = () => {
  return (
    <section id="hero" className="relative min-h-screen bg-cosmic-bg overflow-hidden">
      {/* Mystical Particles */}
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 pointer-events-none">
        <div className="sound-ripple w-32 h-32"></div>
        <div className="sound-ripple w-48 h-48"></div>
        <div className="sound-ripple w-64 h-64"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-silver-pearl mb-8 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <button className="group siren-button text-pearl-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
              <span className="flex items-center gap-2 relative z-10">
                <Play className="w-5 h-5 group-hover:scale-110 transition-transform" />
                Hear Our Sound Demos
              </span>
            </button>
            <button className="group border-2 border-siren-teal text-siren-teal hover:bg-siren-teal hover:text-siren-black px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 siren-glow">
          ...
          <p className="text-silver-pearl text-sm flex items-center justify-center">
